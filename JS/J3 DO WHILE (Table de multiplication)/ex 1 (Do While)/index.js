...
document.write('<p> La phrase la plus longue est la numuero : ' + [index] + ' dans le tableau.<p>')
document.write('<p> La phrase est : ' + phrases[index] + '<p>')
document.write('<p> Elle comporte : ' + phrases[index].length + ' caractères. <p>')
...
do {
    ...
    number = parseFloat(window.prompt('Saisissez votre chiffre'));
